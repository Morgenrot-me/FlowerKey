...
<template>
  ...
  >
    ...
    <template v-else-if="name === 'brain'">
      <path d="M12 2a4 4 0 0 0-4 4c0 .73.2 1.41.54 2H8a4 4 0 0 0-2 7.5A4.5 4.5 0 0 0 8.5 22H12" />
      <path d="M12 2a4 4 0 0 1 4 4c0 .73-.2 1.41-.54 2H16a4 4 0 0 1 2 7.5A4.5 4.5 0 0 1 15.5 22H12" />
      <path d="M12 2v20" />
    </template>
    <!-- 盾牌 -->
