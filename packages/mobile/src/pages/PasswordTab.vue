    ...
    <Transition name="slide-up">
      ...
      <div class="flex-1 px-4 py-4 flex flex-col gap-3 overflow-y-auto">
        ...
        <template v-if="pwdMode === 'generate'">
          ...
          <p class="text-xs text-gray-400 dark:text-gray-500 px-1 -mt-2">区分代号中的英文字母不区分大小写。</p>
          ...
          <p class="text-xs text-gray-400 dark:text-gray-500 px-1">密码由记忆密码、身份密语和区分代号共同生成。三项输入相同，即可在任意设备重建同一密码。</p>
          <!-- 高级选项 -->
