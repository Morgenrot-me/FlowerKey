...
-->
<template>
  <div class="h-full flex flex-col items-center justify-between px-8 py-12">
    ...
    <button @click="$emit('done')" class="w-full max-w-sm py-3 bg-blue-500 text-white rounded-xl text-base font-medium hover:bg-blue-600">
      开始使用
    </button>
  </div>
</template>
