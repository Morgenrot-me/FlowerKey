...
; 1. Welcome Page
!define MUI_WELCOMEPAGE_TITLE "欢迎安装 花钥 FlowerKey"
!define MUI_WELCOMEPAGE_TEXT "花钥是一款本地优先的密码生成与管理工具。\
$\r$\n$\r$\n核心特性：\
$\r$\n  记忆一个主密码，为每个网站生成独立强密码\
$\r$\n  支持书签收藏与加密笔记\
$\r$\n  可通过 WebDAV（如坚果云）跨设备同步\
$\r$\n  所有数据端到端加密，零遥测\
$\r$\n$\r$\n首次使用时请设置记忆密码，此密码决定所有生成密码的结果，请务必牢记。\
$\r$\n$\r$\n点击下一步继续安装。"
